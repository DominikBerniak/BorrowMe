    ...
    return (
        <div className="d-flex w-70 p-5 mx-auto justify-content-around">
            <div id="cost-type-money"
                 className={"d-flex flex-column w-30 px-3 py-2 add-announcementPage-cost-type-button align-items-center justify-content-center rounded cursor-pointer p-1 "
